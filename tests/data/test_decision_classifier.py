"""prose-decision-classifier-v1 on the rubric's own boundary cases (22 §1-§2) and on its contract.
...
def test_every_decision_names_its_step_and_version() -> None:
    ...
    assert decision.as_dict()["classifier_version"] == "prose-decision-classifier-v1"
...
def test_the_classifier_module_reads_no_file_and_names_no_validation_population() -> None:
    """33 §5: the classifier never opens P-DET-v1 or P-DET-COVERAGE-v1. Checked statically: no file access, no
