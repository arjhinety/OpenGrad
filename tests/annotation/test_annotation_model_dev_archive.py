...
TRAILS = {
    ...
    "v2-devcheck-3": (
        "prose-classifier-v2-devcheck-3",
        "model-v2-devcheck-3",
        ROOT / "reports" / "prose-classifier" / "v2-devcheck-3" / "provenance" / "model-v2-devcheck-3",
        [(1, 50), (51, 100), (101, 150)],
    ),
    "v2-devcheck-4": (
        "prose-classifier-v2-devcheck-4",
        "model-v2-devcheck-4",
        ROOT / "reports" / "prose-classifier" / "v2-devcheck-4" / "provenance" / "model-v2-devcheck-4",
        [(1, 50), (51, 100), (101, 150)],
    ),
    "v2-devcheck-5": (
        "prose-classifier-v2-devcheck-5",
        "model-v2-devcheck-5",
        ROOT / "reports" / "prose-classifier" / "v2-devcheck-5" / "provenance" / "model-v2-devcheck-5",
        [(1, 50), (51, 100), (101, 150)],
    ),
}
