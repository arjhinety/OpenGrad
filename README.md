...
| Studies | **Study 001 frozen 2026-09-13** at tag [`study-001`](https://github.com/arjhinety/OpenGrad/tree/study-001). **Study 002 reopened (2026-09-25), no model result:** it is to explain the refusal/direct-answer regression before trying to correct it. Its first `P-UNANS` attempt stopped before training when its preregistered stop rule 2 fired: the unanswerable set could not reach its labeller-agreement floor (0.770 against 0.80). A second attempt ([44](docs/research/study-002/44-PUNANS-V2-AMENDMENT-DRAFT.md), `study_002_prereg_v12`) is drawn and not yet labelled. The four-mode confirmatory set `P-CONF-v1` was built ([negative result](reports/study-002/punans-v1/NEGATIVE-RESULT.md), [current state](docs/research/study-002/README.md#current-state)). On-policy distillation is deferred to Study 003, speculative decoding to Study 004. See [`docs/research/STUDIES.md`](docs/research/STUDIES.md) |
