...
| U-2 | ToolACE's representation in v3 | X supply | **resolved** (31 §3, §5): structured calls. 9,785 of 9,786 call turns also keep the call text in `content`; this affects layer A, not layer B |
