...
| **Next step** | **Draft [36](36-FIRST-REPLY-CONTRACT-AND-PDET-COVERAGE-V2-DRAFT.md) awaits the study owner's adoption.** After v1's test, DIRECT could not be made measurable from single exchanges (about 22 expected in the unused pool, [35](35-OWNER-DECISIONS-AFTER-CLASSIFIER-V1-TEST.md) §4), while Study 001's corpus holds thousands of direct answers as first replies of longer conversations (35 §6). The owner chose to admit first replies; 36 drafts the contract, a 420-item population and classifier v2. P-DET-v1 stays unfrozen. The owner annotates nothing. Nothing authorises C1, a mixture change or training. |
...
| 37 | **Draft** amendment — input contract `prose-decision-input-v2` (the first reply of any conversation), population P-DET-COVERAGE-v2 (420 items) and classifier v2; not adopted | [36-FIRST-REPLY-CONTRACT-AND-PDET-COVERAGE-V2-DRAFT.md](36-FIRST-REPLY-CONTRACT-AND-PDET-COVERAGE-V2-DRAFT.md) |
