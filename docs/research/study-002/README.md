...
| **Decisions needed from the owner** | None open. On 2026-09-25 the owner accepted the `P-UNANS` stop as final: the study does not proceed to training, and no new `P-UNANS` population is being built. A future attempt would need its own amendment, written before its labels, with the 0.80 floor unchanged. P-DET-v1 stays unfrozen; no gold is frozen. |
