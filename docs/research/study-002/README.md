...
| 38 | Classifier v2 development plan — development data from first replies, check rounds, freeze, one test on P-DET-COVERAGE-v2 (plan; §7 records round 1: check set 1 agreed 118 / 125 with model labels, scored once) | [37-PROSE-DECISION-CLASSIFIER-V2-DEVELOPMENT-PLAN.md](37-PROSE-DECISION-CLASSIFIER-V2-DEVELOPMENT-PLAN.md) |
