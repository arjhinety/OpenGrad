...
| **Decisions needed from the owner** | **Adopt draft [44](44-PUNANS-V2-AMENDMENT-DRAFT.md) (`study_002_prereg_v12`), the second `P-UNANS` attempt.** On 2026-09-25 the owner first accepted the `P-UNANS` stop as final, then reopened the study for a second attempt and chose its design: the two models label membership only (unknowable now, not unknowable, undecided); a trial set of about 100 questions is labelled first and never enters `P-UNANS`; no false-premise stratum; unused KUQ questions plus BIG-bench Known Unknowns (screening `study-002-punans-v2`). 44 also proposes KUQP's 40 far-future questions, which the owner was wrongly told had dated years. The 0.80 floor is unchanged; 44 §10 states that it is easier to reach over three labels than over six. Nothing is drawn until the owner adopts 44 and authorises the draw. P-DET-v1 stays unfrozen; no gold is frozen. |
...
| 44 | **Draft, not adopted:** `study_002_prereg_v12`: the second `P-UNANS` attempt: membership-only labels, a trial set, no false-premise stratum, fresh KUQ, KUQP and BIG-bench questions | [44-PUNANS-V2-AMENDMENT-DRAFT.md](44-PUNANS-V2-AMENDMENT-DRAFT.md) |
