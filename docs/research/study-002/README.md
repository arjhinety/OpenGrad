...
| **Next step** | **[36](36-FIRST-REPLY-CONTRACT-AND-PDET-COVERAGE-V2-DRAFT.md) adopted as `study_002_prereg_v6`** (2026-09-17). Contract `prose-decision-input-v2` is in code (`src/opengrad/data/classifier_input.py`). Next, in order (36 §5): the P-DET-COVERAGE-v2 builder and its draw; the three-model reference; the classifier v2 development plan, development data and freeze; the one-shot test. P-DET-v1 stays unfrozen. The owner annotates nothing. Nothing authorises C1, a mixture change or training. |
